...
public class DerailerVisual extends AbstractBlockEntityVisual<DerailerBlockEntity> implements SimpleTickableVisual {
    private final TransformedInstance overlay;
    private BlockPos oldTargetPos;

    public DerailerVisual(VisualizationContext ctx, DerailerBlockEntity blockEntity, float partialTick) {
    ...
    private void setupVisual() {
        TrackTargetingBehaviour<Derailer> target = blockEntity.edgePoint;
